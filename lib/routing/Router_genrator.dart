...
class RouterGenrator {
  static GoRouter mainRouttingInourApp = GoRouter(
    ...
    initialLocation: AppRoutes.userTypeQuestionScreen,
...
GoRoute(
 ...
 GoRoute(
    name: AppRoutes.clientHomeScreen,
    path: AppRoutes.clientHomeScreen ,
    builder: (context, statc) => const ClientHomeScreen(),),
    GoRoute(
    name: AppRoutes.influencersHomeScreen,
    path: AppRoutes.influencersHomeScreen ,
    builder: (context, statc) => const InfluencersHomeScreen(),),

GoRoute(path: AppRoutes.listOfInfluencers,
...
GoRoute(
  ...
  GoRoute(path: AppRoutes.customPromotion,
  name: AppRoutes.customPromotion ,
  builder: (context, state) => CustomPromotion(),),
  GoRoute(path: AppRoutes.platformServices,
