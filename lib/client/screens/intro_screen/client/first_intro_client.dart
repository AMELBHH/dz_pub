...
class FirstIntroClient extends StatelessWidget {
  const FirstIntroClient({super.key});
    ...
    return Scaffold(
      body: Center(
        child: Padding(
          ...
          child: MyFirst(
            image:
                'assets/image/WhatsApp Image 2025-06-21 at 18.01.52_b5152b50.jpg',
            title: 'بحث عن مسوّق',
            description: '.اكتشف أفضل المؤثرين لتسويق منتجك بسهولة وفي دقائق',
            text: 'التالي',
            onPressed: () {
              // Navigator.push(context, MaterialPageRoute(builder: (context)=>Second()));
              context.pushReplacementNamed(AppRoutes.secondIntroClient);
            },
          ),
        ),
      ),
