...
class InfluencerAdvertisementsScreen extends ConsumerStatefulWidget {
  const InfluencerAdvertisementsScreen({super.key});

  @override
  ConsumerState<InfluencerAdvertisementsScreen> createState() =>
      _InfluencerAdvertisementsScreenState();
}

class _InfluencerAdvertisementsScreenState
    extends ConsumerState<InfluencerAdvertisementsScreen> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(promotionProvider.notifier).getAdvertisementsByInfluencer();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('إعلاناتي (كمؤثر)', style: AppTextStyle.textStyle),
        centerTitle: true,
        ...
        onTap: () {
          if (ad.promotion != null) {
            context.pushNamed(
              ...
              extra: ad.promotion,
              queryParameters: {'hideInfluencerDetails': 'true'},
            );
          } else {
